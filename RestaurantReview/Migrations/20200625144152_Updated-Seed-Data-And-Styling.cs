...
{
    public partial class UpdatedSeedDataAndStyling : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "Pepporoni Pizza is awesome. The lady at the counter was great! She tossed in some extra breadsticks because they were honoring the community that day! Thanks again Donato's i'll be back!!!", new DateTime(2020, 6, 25, 10, 41, 51, 168, DateTimeKind.Local).AddTicks(9132) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 5,
                columns: new[] { "Comment", "ReviewDate" },
                values: new object[] { "This place might have ruined Chipotle for me. The food here is so amazing I don’t want any Mexican anywhere else again!", new DateTime(2020, 6, 25, 10, 41, 51, 173, DateTimeKind.Local).AddTicks(3331) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 6,
                columns: new[] { "Comment", "ReviewDate" },
                values: new object[] { "We love Agave! Very family friendly, great prices, great food and nice staff! Highly recommend their queso and chips! This is a fast casual type of restaurant.", new DateTime(2020, 6, 25, 10, 41, 51, 173, DateTimeKind.Local).AddTicks(3335) });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Comment", "ReviewDate" },
                values: new object[] { " Pepporoni Pizza is awesome", new DateTime(2020, 6, 24, 11, 17, 36, 877, DateTimeKind.Local).AddTicks(4139) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "Comment", "ReviewDate" },
                values: new object[] { "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed est quam, ornare sit amet pretium non, posuere rhoncus dui. Curabitur gravida risus eget risus scelerisque, eu tristique velit accumsan. Nam ligula purus, sagittis sed dolor vitae, posuere accumsan purus. Donec metus velit, commodo eu viverra in, lobortis ac diam. Suspendisse lacinia mi mauris, at ultrices dolor maximus eget. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos", new DateTime(2020, 6, 24, 11, 17, 36, 879, DateTimeKind.Local).AddTicks(2990) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 4,
                columns: new[] { "Comment", "ReviewDate" },
                values: new object[] { " Their burritos were great!", new DateTime(2020, 6, 24, 11, 17, 36, 879, DateTimeKind.Local).AddTicks(2995) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 5,
                columns: new[] { "Comment", "ReviewDate" },
                values: new object[] { " Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed est quam, ornare sit amet pretium non, posuere rhoncus dui. Curabitur gravida risus eget risus scelerisque, eu tristique velit accumsan. Nam ligula purus, sagittis sed dolor vitae, posuere accumsan purus. Donec metus velit, commodo eu viverra in, lobortis ac diam. Suspendisse lacinia mi mauris, at ultrices dolor maximus eget. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos", new DateTime(2020, 6, 24, 11, 17, 36, 879, DateTimeKind.Local).AddTicks(2998) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 6,
                columns: new[] { "Comment", "ReviewDate" },
                values: new object[] { "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed est quam, ornare sit amet pretium non, posuere rhoncus dui. Curabitur gravida risus eget risus scelerisque, eu tristique velit accumsan. Nam ligula purus, sagittis sed dolor vitae, posuere accumsan purus. Donec metus velit, commodo eu viverra in, lobortis ac diam. Suspendisse lacinia mi mauris, at ultrices dolor maximus eget. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos", new DateTime(2020, 6, 24, 11, 17, 36, 879, DateTimeKind.Local).AddTicks(3001) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 7,
                columns: new[] { "Comment", "ReviewDate" },
                values: new object[] { "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed est quam, ornare sit amet pretium non, posuere rhoncus dui. Curabitur gravida risus eget risus scelerisque, eu tristique velit accumsan. Nam ligula purus, sagittis sed dolor vitae, posuere accumsan purus. Donec metus velit, commodo eu viverra in, lobortis ac diam. Suspendisse lacinia mi mauris, at ultrices dolor maximus eget. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos", new DateTime(2020, 6, 24, 11, 17, 36, 879, DateTimeKind.Local).AddTicks(3004) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 8,
                columns: new[] { "Comment", "ReviewDate" },
                values: new object[] { "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed est quam, ornare sit amet pretium non, posuere rhoncus dui. Curabitur gravida risus eget risus scelerisque, eu tristique velit accumsan. Nam ligula purus, sagittis sed dolor vitae, posuere accumsan purus. Donec metus velit, commodo eu viverra in, lobortis ac diam. Suspendisse lacinia mi mauris, at ultrices dolor maximus eget. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos", new DateTime(2020, 6, 24, 11, 17, 36, 879, DateTimeKind.Local).AddTicks(3007) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 9,
                columns: new[] { "Comment", "ReviewDate" },
                values: new object[] { "The seafood here is pretty ok for Lake Erie", new DateTime(2020, 6, 24, 11, 17, 36, 879, DateTimeKind.Local).AddTicks(3011) });
        }
    }
}
